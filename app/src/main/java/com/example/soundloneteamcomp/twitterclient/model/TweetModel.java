...
public class TweetModel implements Identifiable {
    ...
    private TweetModel() {
        this(null, null, null, new TweetEntities(null, null, null, null, null), new TweetEntities(null, null, null, null, null), 0, false, null, 0, "0",
    ...
    public TweetModel(Coordinates coordinates, String createdAt, Object currentUserRetweet,
                      ...
                      UserModel user, boolean withheldCopyright, List<String> withheldInCountries,
                      String withheldScope, Card card) {
        this.coordinates = coordinates;
        this.createdAt = createdAt;
        this.currentUserRetweet = currentUserRetweet;
        this.entities = entities == null ? new TweetEntities(null, null, null, null, null) : entities;
        this.extendedEntities = extendedEntities == null ? new TweetEntities(null, null, null, null, null) : extendedEntities;
